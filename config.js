// ============================================================
// EstudaMais — Configuração
// ============================================================
// Cole aqui as DUAS informações públicas do seu projeto Supabase.
// Encontre em: Supabase → Settings → API
//
// ATENÇÃO: a "anon key" é PÚBLICA e pode ficar no front-end com
// segurança — ela só permite o que as políticas (RLS) do banco
